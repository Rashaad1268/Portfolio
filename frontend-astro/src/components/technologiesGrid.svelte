<script lang="ts">
  import { technologiesData } from "../lib/data.ts";
</script>

<div class="technology-grid">
  {#each technologiesData as technology, index}
    <div class="technology-card" style="--card-index: {index}">
...
<style lang="scss">
  .technology-card {
    @apply z-[var(--card-index)] mb-[5px] flex min-w-[240px] -mr-10 flex-col items-center
