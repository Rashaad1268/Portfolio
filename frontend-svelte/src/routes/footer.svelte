<script>
    import { twitterUrl, githubUrl, youtubeUrl, discordServerUrl, sourceCodeUrl, flutterPortfolioUrl } from "$lib/data";
</script>
...
<footer>
    ...
    <div>
        ...
        <a href="https://fontawesome.com/" class="icon-link" target="_blank" rel="noreferrer">FontAwesome</a>
        <a href="https://svelte.dev/" class="icon-link" target="_blank" rel="noreferrer">Svelte</a>
        <a href="https://tailwindcss.com/" class="icon-link" target="_blank" rel="noreferrer">TailwindCSS</a>
    </div>
</footer>
...
<style lang="postcss">
    ...
    .footer-title {
        @apply text-2xl font-medium mb-3 gdark:text-neutral-300;
    }
    ...
    .icon-link.big > svg {
        @apply h-10 w-10 gdark:fill-white hover:bg-[length:0%_0px];
    }
</style>